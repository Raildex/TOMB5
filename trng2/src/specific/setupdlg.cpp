...
static INT_PTR SetupDlgProc(HWND dlg, UINT message, WPARAM wParam, LPARAM lParam)
{
...
bool SetupDialog()
{
	...
	ShowCursor(1);
	ret = DialogBox(App.hInstance, MAKEINTRESOURCE(IDD_SETUPDIALOG), 0, (DLGPROC)SetupDlgProc);
